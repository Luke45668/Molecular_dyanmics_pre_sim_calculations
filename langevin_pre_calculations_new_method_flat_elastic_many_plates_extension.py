...
This script will does all the pre calcs flat elastic particle simulations from a template then produces the simulation run files for MYRIAD. 
...
abs_path_2_lammps_script='/home/ucahlrl/simulation_run_folder/in.brownian_uef_flat_elastic_particles'
...
0.975,0.975,0.975,0.975,0.975,0.975,0.975,0.975,0.975,0.975,1])
...
path="/Users/luke_dev/Documents/simulation_run_folder/eq_run_tri_plate_damp_0.035_K_4000"
# os.mkdir(path)
os.chdir(path)
run_code_list=[]
h=0 # damp=0.035

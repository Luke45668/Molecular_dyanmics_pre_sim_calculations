...
def SRD_MASTER_calc_dimensional_no_M_variation(mass_fluid_particle_wrt_pf_cp_mthd_1,box_side_length,number_boxes_vec,tolerance,nu_s,Solvent_bead_SRD_box_density_cp_1 ,r_particle, box_size_vec ,T_K,k_b,rho_s,eta_s):
...
#########################################################################    
    ...
    gamma_1 = ((1 - ((1-np.exp(-(Solvent_bead_SRD_box_density_cp_1)))/(Solvent_bead_SRD_box_density_cp_1))))
    gamma_2 = ( (((Solvent_bead_SRD_box_density_cp_1)+2)/((Solvent_bead_SRD_box_density_cp_1)-1)))
#########################################################################   
    ...
    number_SRD_particles_wrt_pf_cp_mthd_1 = np.ceil(Number_of_SRD_boxes_in_sim_box_wrt_pf * Solvent_bead_SRD_box_density_cp_1)
...
#########################################################################    
    ...
    D_f_neg_dm =( M*k_b*T_K.T *SRD_timestep_cp_1_based_on_sphere_neg_dimensional_check.T * gamma_3)/ (rho_s * SRD_box_size_wrt_solid_beads_check**3).T
    D_f_pos_dm=( M*k_b*T_K.T *SRD_timestep_cp_1_based_on_sphere_pos_dimensional_check.T * gamma_3)/ (rho_s * SRD_box_size_wrt_solid_beads_check**3).T
    ...
    sc_pos_soln=nu_pos_dm/D_f_pos_dm.T
    sc_neg_soln=nu_neg_dm/D_f_neg_dm.T
#########################################################################           
    ...
    number_SRD_particles_wrt_pf_cp_mthd_1_pos = np.ceil(Number_of_SRD_boxes_in_sim_box_wrt_pf * Solvent_bead_SRD_box_density_cp_1)
    number_SRD_particles_wrt_pf_cp_mthd_1_neg = np.ceil(Number_of_SRD_boxes_in_sim_box_wrt_pf * Solvent_bead_SRD_box_density_cp_1)

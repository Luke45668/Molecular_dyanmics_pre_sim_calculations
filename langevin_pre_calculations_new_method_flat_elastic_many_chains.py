...
abs_path_2_lammps_script='/home/ucahlrl/simulation_run_folder/lammps_scripts/in.langevin_with_hookean_flat_elastic_tri_plate_chain_mol'
...
#K=15,20 
# first attempt multipliers, lowest 4 were successful 
timestep_multiplier=np.array(

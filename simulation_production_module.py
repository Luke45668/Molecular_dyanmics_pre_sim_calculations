...
# use to test various thermal damping times over a fixed set of shear rate
...
# assigns a specific thermal damp to each erate
def sim_file_prod_flat_elastic_MYRIAD_all_erate_one_file_var_damp(SRD_MD_ratio_,collision_time_negative_bar,bending_stiffness,damp,input_temp,
                                                         erate,
                                                         equilibrium_triangle_side_length,
                                                         var_choice_1,var_choice_2,internal_stiffness,
                                                         data_transfer_instructions,extra_code,wd_path,
    ...
    for m in range(0,var_choice_2.size): 
             for k in range(erate.size): 
                thermal_damp_multi=thermal_damp_multiplier[k]   
        #for k in range(0,1):   
...
def sim_file_prod_flat_elastic_MYRIAD_all_erate_one_file_langevin(SRD_MD_ratio_,collision_time_negative_bar,

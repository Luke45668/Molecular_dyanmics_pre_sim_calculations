...
print('collision_time_negative_bar',collision_time_negative_bar)
...
#%% Producing scripts for kathleen
##################
...
#abs_path_2_lammps_script='/home/ucahlrl/simulation_run_folder/pure_srd_equilibrium_hdf5_dump.file'


abs_path_2_lammps_exec='/Volumes/Backup\ Plus\ 1/PhD_/Rouse\ Model\ simulations/Using\ LAMMPS\ imac/lammps-23Jun2022/build_imac_hdf5/lmp_mpi'
abs_path_2_lammps_script='/Volumes/Backup\ Plus\ 1/PhD_/Rouse\ Model\ simulations/Using\ LAMMPS\ imac/LSC/pure_srd_equilibrium_hdf5_dump.file'
...
hypthread='2'
box_size_index=1
fluid_name='M_10_'+str(box_size_bar[box_size_index])+'_'
max_cores= 80



realisation_index_=[1,2,3,4]
...
# %% producing scripts for myriad
Path_2_shell_scirpts='/Volumes/Backup Plus 1/PhD_/Rouse Model simulations/Using LAMMPS imac/Shell_scripts_for_MYRIAD'
#MYRIAD path
abs_path_2_lammps_exec='/home/ucahlrl/simulation_run_folder/lammps-23Jun2022/build_MYRIAD_Pure_SRD/lmp_mpi'
abs_path_2_lammps_script='/home/ucahlrl/simulation_run_folder/in.pure_srd_nonequilibrium_hdf5_dump_full'
...
#%%
sim_file_prod_fix_deform_pure_individual_MYRIAD(nu_bar,erate_,var_choice_1,var_choice_2,data_transfer_instructions,extra_code,wd_path,np_req,num_task_req,tempdir_req,wall_time,ram_requirement,realisation_index_,VP_ave_freq,abs_path_2_lammps_exec,abs_path_2_lammps_script,no_timestep_,thermo_freq,md_timestep,i_,j_,box_size_bar,box_size_index,Path_2_shell_scirpts,Path_2_generic,fluid_name,SRD_MD_ratio_,dump_freq_)
# %%
